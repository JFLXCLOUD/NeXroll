...
///
/// Emby's <see cref="IIntroProvider"/> interface is nearly identical to
/// Jellyfin's but lives in the Emby SDK namespace.  The logic is the same
/// as the Jellyfin variant.
/// </summary>
    ...
    public async Task<IEnumerable<IntroInfo>> GetIntros(BaseItem item, User user)
    {
        ...
        try
        {
            ...
            _logger.LogInformation(
                "NeXroll: Injecting {Count} intro(s) before {MediaType} '{Name}'",
