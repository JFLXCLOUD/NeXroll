...
try:
    import nexroll_backend.database  # noqa: F401
    import nexroll_backend.models  # noqa: F401
    import nexroll_backend.scheduler  # noqa: F401
    import nexroll_backend.plex_connector  # noqa: F401
except Exception as e:
    print(f"Preload failed: {e}")

# Importing backend.main is enough; it self-starts uvicorn when sys.frozen is True.
try:
    import nexroll_backend.main as _backend_main  # noqa: F401
except Exception as e:
    # Surface import failures to console for troubleshooting in portable runs.
    print(f"Launcher failed to import nexroll_backend.main: {e}")
    raise