...
const CACHE_NAME = 'nexroll-v2.2.0-beta.11';
const STATIC_CACHE = 'nexroll-static-v2.2.0-beta.11';
const API_CACHE = 'nexroll-api-v2.2.0-beta.11';
...
const STATIC_ASSETS = [
 ...
 '/manifest.json',
 '/favicon.ico',
 '/icons/nexroll-logo-black.png',
 '/icons/nexroll-logo-white.png'
];
